...
def coviddata_who(countries):
    ...
    if "France" in countries:
        covid_france = coviddata_who["France"].sum(axis="columns")
        coviddata_who = coviddata_who.drop("France", axis="columns")
        coviddata_who["France"] = covid_france
    if "United States of America" in countries:
        covid_france = coviddata_who["United States of America"].sum(axis="columns")
        coviddata_who = coviddata_who.drop("United States of America", axis="columns")
    ...
    for country in countries:
        coviddata_who[country] = coviddata_who[who_naming[country]]
