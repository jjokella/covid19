...
coviddata_csse_confirmed = pd.read_csv(
    os.environ['HOME'] +
    "/covid19/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv",
    sep=',',
)
coviddata_csse_deaths = pd.read_csv(
    os.environ['HOME'] +
    "/covid19/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv",
    sep=',',
)

coviddata_csse_recovered = pd.read_csv(
    os.environ['HOME'] +
    "/covid19/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv",
    sep=',',
)
