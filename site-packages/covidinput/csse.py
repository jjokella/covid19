...
coviddata_csse_all = pd.read_csv(
    os.environ['HOME'] + "/covid19/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Confirmed.csv",
    sep=',',
)
...
def coviddata_csse(country, is_add_log=False, is_add_growth_factor=False):
    ...
    if is_add_log:
        coviddata_csse = cvdff.add_log(coviddata_csse, country)

    if is_add_growth_factor:
        coviddata_csse = cvdff.add_growth_factor(coviddata_csse, country)
