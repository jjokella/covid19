...
def coviddata_eudata_germany():
    ...
    coviddata_eudata_full = coviddata_eudata_full.rename(
        {"cases":"Confirmed", "deaths":"Deaths"}, axis=1)

    # First try
    coviddata_eudata = coviddata_eudata_full[coviddata_eudata_full["state"]=="sum"]
    coviddata_eudata = coviddata_eudata.rename({"Confirmed":"Germany", "Deaths":"Germany-Deaths"}, axis=1)
    ...
    for land in bundeslaender:
        coviddata_eudata_land = coviddata_eudata_full[coviddata_eudata_full["state"]==land]
        coviddata_eudata_land = coviddata_eudata_land.rename({"Confirmed":land, "Deaths":land+"-Deaths"}, axis=1)
        coviddata_eudata_land = coviddata_eudata_land.drop(["state"], axis=1)
        coviddata_eudata_land.index = pd.to_datetime(coviddata_eudata_land["datetime"])
        coviddata_eudata_land = coviddata_eudata_land.drop("datetime", axis=1)

        coviddata_eudata[land] = coviddata_eudata_land[land]
        coviddata_eudata[land+"-Deaths"] = coviddata_eudata_land[land+"-Deaths"]
...
def coviddata_eudata_france():
    ...
    """
    # Drop unneeded
    coviddata_eudata_full = coviddata_eudata_fr.drop(
        ["country"], axis=1)
    ...
    # First try
    coviddata_eudata = coviddata_eudata_full[coviddata_eudata_full["authority"]=="sum"]
    ...
    for land in districts:
        coviddata_eudata_land = coviddata_eudata_full[coviddata_eudata_full["authority"]==land]
        coviddata_eudata_land = coviddata_eudata_land.rename({"Confirmed":land}, axis=1)
        coviddata_eudata_land = coviddata_eudata_land.drop(["authority"], axis=1)
        coviddata_eudata_land.index = pd.to_datetime(coviddata_eudata_land["datetime"])
        coviddata_eudata_land = coviddata_eudata_land.drop("datetime", axis=1)
